                    ...
                    <tr v-for="(tag, index) in tags" :key="tag.id">
                        <td class="align-middle">
                            <div class="d-flex flex-column align-items-center gap-1">
                                <button type="button"
                                    ...
                                    @click="updateSort(tag.id, 'up')"
                                    title="上移">
                                    <i class="fa-solid fa-caret-up"></i>
                                </button>
                                <button type="button"
                                    class="btn btn-sm btn-outline-secondary sort-btn"
                                    :disabled="index === tags.length - 1 || sorting"
                                    @click="updateSort(tag.id, 'down')"
                                    title="下移">
                        ...
                        <td class="align-middle">
                            <div class="d-flex flex-wrap align-items-center gap-1">
                                <div v-for="(child, childIndex) in tag.children" :key="child.id"
                                    ...
                                    <button type="button"
                                        class="btn btn-sm child-sort-btn"
                                        :disabled="childIndex === 0 || sorting"
                                        @click="updateSort(child.id, 'up')"
                                        title="前移">
                                    ...
                                    <button type="button"
                                        ...
                                        @click="updateSort(child.id, 'down')"
                                        title="後移">
                        ...
                        <td class="align-middle">
                            <button type="button" class="btn btn-sm btn-secondary me-1"
                                @click="edit(tag)">編輯</button>
                            <button type="button" class="btn btn-sm btn-danger"
                                @click="confirmDelete(tag)">刪除</button>
                        </td>
                    </tr>
                    <tr v-if="tags.length === 0">
                        <td colspan="4" class="text-center text-muted py-4">尚無任何標籤</td>
                    </tr>
                </tbody>
            </table>
        </div>
            ...
            <div class="p-3">
                ...
                <div class="mt-3">
                    <button type="button" class="btn btn-secondary me-2"
                        @click="modal('delete_model', 'hide')">取消</button>
            ...
            <div class="p-3">
                <div class="mt-2">
                    ...
                    <input type="text" class="form-control" v-model="form.name"
                        placeholder="請輸入您的主要選單名稱"
                        @keyup.enter="$refs.childInput.focus()">
                </div>
                <div class="mt-3">
                    <label class="form-label fw-bold">子選單</label>
                    <div class="input-group">
                        <input type="text" class="form-control" ref="childInput"
                            v-model="childInput"
                            placeholder="輸入子選單名稱後按 Enter 或點新增"
